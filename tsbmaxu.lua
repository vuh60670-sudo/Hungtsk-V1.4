local Config = {
    ...
    Secret          = "C", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://github.com/vuh60670-sudo/keytsb.git", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "tsb key pro", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "địt con mẹ mày banana hub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "tsb pro", -- The main title shown at the top of the GUI
    HubDescription  = "key pro" -- The text shown below the title
}
